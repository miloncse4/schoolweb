    ...
    <div class="col-12">          
      <div class="card">
        <div class="card-header bg-info d-sm-flex align-items-center justify-content-between">
          <h3 class="card-title text-light"><b><i>All Student ID card print Heare</i></b></h3>
        ...
        @endif
        <form method="GET" action="{{ route('student_id.get') }}" id="MyForm" target="__blank">
        @csrf
          <div class="card-body">            
            <div class="form-row">                   
              ...
              <div class="form-group col-md-12">
                <button type="submit" class="btn btn-info"><i>Search</i></button>            
              </div>
            </div>            
          </div>
        </form>
