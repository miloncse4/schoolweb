    ...
    <div class="col-12">          
      <div class="card">
        <div class="card-header bg-success d-sm-flex align-items-center justify-content-between">
          <h3 class="card-title text-light"><b><i>All Student Result Serach Heare</i></b></h3>
        ...
        @endif
        <form method="GET" action="{{ route('result.get') }}" id="MyForm" target="__blank">
        @csrf
          <div class="card-body">            
            <div class="form-row">                   
              ...
              <div class="form-group col-md-12">
                <button type="submit" class="btn btn-success"><i>Search</i></button>            
              </div>
            </div>            
          </div>
        </form>
