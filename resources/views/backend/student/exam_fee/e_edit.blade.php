...
<div class="container">
    <div class="card mt-5">
      <div class="card-header bg-danger d-sm-flex align-items-center justify-content-between">
        <h2 class="text-light"><i><b>Edit Exam Fee</b></i></h2>
        <a href="{{ route('student.exam.view') }}" class="btn btn-sm btn-dark" style="font-weight:bold;">
      Back </a>
      </div>
      <div class="card-body">
        @if(session('InsErr'))
        ...
        @endif
        <form action="{{route('student.exam.update',$data->id)}}" method="post">
            @csrf
        <div class="add_item">
