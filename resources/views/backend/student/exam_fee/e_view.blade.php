...
<div class="container">
    <div class="card mt-5">
      <div class="card-header bg-dark d-sm-flex align-items-center justify-content-between">
        <h2 class="text-light"><i>Student Exam Fee</i></h2>
              ...
              <tbody>
               @forelse($mon as $al)
                <tr>
                  ...
                  <td>{{$al->amount}}</td>
                  <td>
                    <a href="{{ route('student.exam.edit',$al->id) }}" title="Edit" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                    <a href="{{ route('student.exam.delete',$al->id) }}" id="delete" title="Delete" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                @empty
                <tr>
